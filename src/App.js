...
function App() {
  ...
  return (
    <div className="app d-flex flex-row flex-wrap">
      ...
      {/* Right content */}
      <div className="right" onClick={() => settingNav && setSettingNav("")}>
        <Profile activePage={activePage} setActivePage={setActivePage} />
        ...
        <Certificates activePage={activePage} setActivePage={setActivePage} />
      </div>
    </div>
  );
}
